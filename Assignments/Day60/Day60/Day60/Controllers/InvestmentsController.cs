...
namespace Day60.Controllers
{
    public class InvestmentsController : Controller
    {
        ...
        //    {
        //        Id=1,
        //        TickerSymbol="SilverBees",
        //        AssetName="MAx",
        //        Quantity=50,
        //        PurchasePrice=1200,
        //        PurchaseDate=new DateTime(2026,03,15)
        //    }
        ...
        {
            InvestmentCreateViewModel investmentCreateViewModel = new InvestmentCreateViewModel();
        ...
        public async Task<IActionResult> Create(InvestmentCreateViewModel investmentCreateViewModel)
        {
            if (ModelState.IsValid)
            {
                var model = new Investment
                {
                    ...
                    AssetName = investmentCreateViewModel.AssetName,
